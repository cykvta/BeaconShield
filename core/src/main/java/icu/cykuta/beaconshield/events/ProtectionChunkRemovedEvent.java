...
public class ProtectionChunkRemovedEvent extends Event {
    private static final HandlerList HANDLERS = new HandlerList();
    private final ProtectedChunk protectedChunk;
    private final BeaconShieldBlock beaconShieldBlock;

    public ProtectionChunkRemovedEvent(ProtectedChunk protectedChunk, BeaconShieldBlock beaconShieldBlock) {
